...
#Khusus Lpgin Token
cl = LINE('EzkMzqrYNyMiLqf5lJc0.9q2iIcfJltjghJCvoSD1Wa.o7RpcUCtv8g6+ey9Llp0mZqlKBz81syCmcjk2fbwU2c=')
cl.log("Auth Token : " + str(cl.authToken))
cl.log("Timeline Token : " + str(cl.tl.channelAccessToken))

ki = LINE('EzkMzqrYNyMiLqf5lJc0.9q2iIcfJltjghJCvoSD1Wa.o7RpcUCtv8g6+ey9Llp0mZqlKBz81syCmcjk2fbwU2c=')
ki.log("Auth Token : " + str(cl.authToken))
ki.log("Timeline Token : " + str(cl.tl.channelAccessToken))

kk = LINE('EzkMzqrYNyMiLqf5lJc0.9q2iIcfJltjghJCvoSD1Wa.o7RpcUCtv8g6+ey9Llp0mZqlKBz81syCmcjk2fbwU2c=')
kk.log("Auth Token : " + str(cl.authToken))
kk.log("Timeline Token : " + str(cl.tl.channelAccessToken))

kc = LINE('EzkMzqrYNyMiLqf5lJc0.9q2iIcfJltjghJCvoSD1Wa.o7RpcUCtv8g6+ey9Llp0mZqlKBz81syCmcjk2fbwU2c=')
        ...
        if op.type == 11:
            if not op.param2 in Bots:
                if wait["CloseQR"] == True:
                  try:
                      klist=[cl,ki,kk,kc] #TAKUT SALAH KASIH TANDA AJA KY INI 
